...
namespace Practica1
{
    public partial class Main : Form
    {
        ...
        private void ConnectCamera()
        {
            ...
            btnConnect.BackgroundImage = global::Practica1.Properties.Resources.unlink;
        ...
        private void VideoProcessing(CancellationToken token)
        {
            ...
            using (var win = new OpenCvSharp.Window("Imagen"))
            {
                while (!token.IsCancellationRequested)
                {
                    ...
                    Cv2.Circle(FilteredImage, new Point(x, y), (int)(Math.Sqrt(moments.M00 / 255)), new Scalar(255, 255, 0), 2);
                    //Cortar 60 x 60
        ...
        private void DisconnectCamera()
        {
            ...
            btnConnect.BackgroundImage = global::Practica1.Properties.Resources.link;
        }
        #endregion
